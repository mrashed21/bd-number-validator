...
function BDPhoneInput({
  ...
  return /* @__PURE__ */ jsxs("div", { className: `${wrapperClass} ${className}`, children: [
    label && /* @__PURE__ */ jsx("label", { className: labelClass, children: label }),
    /* @__PURE__ */ jsxs(
      "div",
      {
    ...
    showError && raw.length >= 3 && error && (customError ? customError(error) : /* @__PURE__ */ jsx("span", { className: "bdp-error-text", children: error }))
  ] });
}
